...
#define DEVICE_NAME                      "IoT Bridge"                               /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME                "ManiaCS_17"                      /**< Manufacturer. Will be passed to Device Information Service. */
...
static void timer_timeout_handler(void * p_context)
{
    // OUR_JOB: Step 3.F, Update temperature and characteristic value.
		...
		our_termperature_characteristic_update(&m_ir_service, &temperature);
		}
...
static void services_init(void)
{
    ...
    */
    ...
    APP_ERROR_CHECK(err_code);
		...
		memset(&m_ir_service, 0, sizeof(nus_init));
		ir_service_init(&m_ir_service);
}
...
static void ble_evt_dispatch(ble_evt_t * p_ble_evt)
{
    ...
    ble_advertising_on_ble_evt(p_ble_evt);
	  ...
	  ble_ir_service_on_ble_evt(&m_ir_service, p_ble_evt);
